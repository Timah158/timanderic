...
const Footer = () => {
    return (
      <footer>
        ...
        <a href="https://www.linkedin.com/in/timlopez22"><LinkedInIcon className='footer_icon'/></a>
        <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ"><EmailIcon className='footer_icon'/></a>
      </footer>
    );
  }
